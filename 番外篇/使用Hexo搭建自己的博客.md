...
这里顺便啰嗦两句，在互联网如此发达的今天，应该如何营销自己呢？自我营销首先要从打造个人品牌做起，对于程序员来说，最容易去做好的一件事情还是搭建自己的博客。博客相当于是你在互联网上的一个基地，尤其是当你拥有了属于自己的独立博客后，你可做很多自己想做的事情，既可传达自己的思想，又可提升自己的影响力，当然如果你的博客经营得非常好，你可从中获利。除了博客，直播、视频网站、投稿、写书、技术活动都是可选的自我营销方式。做自我营销也需要持之以恒，三天打鱼两天晒网是很难有什么收获的。
...
从运行命令的提示信息可看到，服务器已经运转起并使用了 4000 端口，可通过`Ctrl+C`来终止服务器的运行。如果要修改服务器使用的端口，可在启动服务器的时加上`-p`参数；如果希望服务器启动后，自动打开默认的浏览器访问服务器，可使用`-o`参数
